 ...
 *    date   : 2017/11/08
 *    desc   : 简化的 RecyclerView Adapter, 不要继承直接创建内部类就可以使用, 懒人专用
 * </pre>
 */
abstract class SimplifiedRcvAdapter<T> extends RecyclerView.Adapter<SimplifiedRcvAdapter.LshSimplifiedViewHolder> {

    private List<T> list;
    private int layoutId;

    public SimplifiedRcvAdapter(int layoutId, List<T> list) {
