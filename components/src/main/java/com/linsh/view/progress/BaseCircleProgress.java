package com.linsh.view.progress;
...
abstract class BaseCircleProgress extends View {
    ...
    protected void setProgressWithAnimation(int[] progresses, long duration) {
        ...
        if (mCurrentProgresses == null || mCurrentProgresses.length < progresses.length) {
            mCurrentProgresses = getCopy(mCurrentProgresses, progresses.length);
        }

        mStartProgresses = getCopy(mCurrentProgresses);
    ...
    private static int[] getCopy(int[] srcArray) {
        if (srcArray == null) {
            return null;
        }
    ...
    private static int[] getCopy(int[] srcArray, int newLength) {
