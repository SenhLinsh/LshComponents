...
import com.linsh.utilseverywhere.ColorSelectors;
import com.linsh.utilseverywhere.DrawableSelectors;
import com.linsh.utilseverywhere.Shapes;
...
public class CountDownView extends AppCompatTextView {
    ...
    private void setColor() {
        // 设置字体颜色
        setTextColor(ColorSelectors.enabled(enabledColor, disabledColor));
        // 设置背景
        Drawable enabledDrawable = Shapes.rectangle(0, roundRadius, strokeWidth, enabledColor);
        Drawable disabledDrawable = Shapes.rectangle(0, roundRadius, strokeWidth, disabledColor);
        StateListDrawable background = DrawableSelectors.enabled(enabledDrawable, disabledDrawable);
